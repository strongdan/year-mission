...
## Implemented in `feat/home-journal`

- **YM-RM-009 — Home-screen journaling with optional AI analysis:** additive owner-isolated journal schema, Today quick reflection, optional AI analysis with provider/model/cost provenance, safe structured-output degradation, and explicit user-controlled promotion of a suggested action to Inbox. AI never silently changes the task plan.
